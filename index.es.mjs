import { effectScope as Ur, ref as ae, shallowRef as Yr, computed as be, watch as qe, isRef as jr, defineComponent as Bt, getCurrentInstance as Kt, h as zo, Fragment as ue, inject as ft, onMounted as Tt, onUnmounted as xn, createVNode as N, Text as Xr, createElementBlock as D, openBlock as C, renderSlot as ge, createBlock as ie, normalizeClass as Qe, withCtx as B, createElementVNode as w, renderList as Oe, onBeforeUnmount as Gr, toDisplayString as M, unref as z, pushScopeId as Kr, popScopeId as Jr, nextTick as Zr, normalizeProps as Qr, guardReactiveProps as ea, resolveComponent as oi, mergeProps as xi, withScopeId as ta, withKeys as na, normalizeStyle as Mt, createCommentVNode as fe, resolveDynamicComponent as ia, withDirectives as Fe, vShow as It, createTextVNode as Q, toRefs as oa, reactive as ri, vModelText as ln, withModifiers as Ho, vModelSelect as ra, vModelCheckbox as aa, provide as Wo, toRaw as sa, onBeforeMount as la, defineCustomElement as ca, createApp as da } from "vue";
const St = {
...
/*!
  ...
  */
const qn = typeof window < "u", Pt = (e, t = !1) => t ? Symbol.for(e) : Symbol(e), va = (e, t, n) => ya({ l: e, k: t, s: n }), ya = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), Se = (e) => typeof e == "number" && isFinite(e), _a = (e) => ki(e) === "[object Date]", Jt = (e) => ki(e) === "[object RegExp]", Un = (e) => ee(e) && Object.keys(e).length === 0, Ae = Object.assign, ba = Object.create, me = (e = null) => ba(e);
let Hi;
...
const Ee = Array.isArray, ve = (e) => typeof e == "function", W = (e) => typeof e == "string", le = (e) => typeof e == "boolean", ce = (e) => e !== null && typeof e == "object", xa = (e) => ce(e) && ve(e.then) && ve(e.catch), Yo = Object.prototype.toString, ki = (e) => Yo.call(e), ee = (e) => ki(e) === "[object Object]", ka = (e) => e == null ? "" : Ee(e) || ee(e) && e.toString === Yo ? JSON.stringify(e, null, 2) : String(e);
function Ti(e, t = "") {
...
function Oa(e) {
  const t = e;
  let n = 0, i = 1, r = 1, s = 0;
  const l = ($) => t[$] === Pa && t[$ + 1] === Me, u = ($) => t[$] === Me, f = ($) => t[$] === La, d = ($) => t[$] === Aa, b = ($) => l($) || u($) || f($) || d($), h = () => n, p = () => i, x = () => r, k = () => s, S = ($) => l($) || f($) || d($) ? Me : t[$], P = () => S(n), g = () => S(n + s);
  function T() {
...
function Na(e, t = {}) {
  ...
  function h(v, y, R, ...Y) {
    ...
    if (y.column += R, y.offset += R, b) {
      const o = n ? ai(_e.startLoc, y) : null, a = Yn(v, o, {
        domain: Ia,
        args: Y
      });
      b(a);
  ...
  function p(v, y, R) {
    ...
    const Y = { type: y };
    return n && (Y.loc = ai(v.startLoc, v.endLoc)), R != null && (Y.value = R), Y;
  }
  const x = (v) => p(
    v,
    13
  ...
  function k(v, y) {
    return v.currentChar() === y ? (v.next(), y) : (h(de.EXPECTED_TOKEN, s(), 0, y), "");
  }
  function S(v) {
    let y = "";
  ...
  function G(v, y) {
    ...
    const Y = () => {
      ...
      return o === "{" ? g(v.peek()) : o === "@" || o === "|" || o === ":" || o === "." || o === ct || !o ? !1 : o === Me ? (v.peek(), Y()) : se(v, !1);
    }, _e = Y();
    return v.resetPeek(), _e;
  }
  function U(v) {
  ...
  function Wt(v) {
    ...
    for (; y = pe(v); )
      R += y;
    return v.currentChar() === vt && h(de.UNTERMINATED_CLOSING_BRACE, s(), 0), R;
  }
  function en(v) {
    P(v);
    let y = "";
    return v.currentChar() === "-" ? (v.next(), y += `-${Ht(v)}`) : y += Ht(v), v.currentChar() === vt && h(de.UNTERMINATED_CLOSING_BRACE, s(), 0), y;
  }
  function En(v) {
    return v !== Vi && v !== Me;
  }
  function Vt(v) {
    ...
    return Y === Me || Y === vt ? (h(de.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, s(), 0), Y === Me && (v.next(), k(v, "'")), R) : (k(v, "'"), R);
  }
  function tn(v) {
    const y = v.currentChar();
    switch (y) {
      ...
      case "U":
        return Ut(v, y, 6);
      default:
        return h(de.UNKNOWN_ESCAPE_SEQUENCE, s(), 0, y), "";
    }
  }
  function Ut(v, y, R) {
    k(v, y);
    ...
    for (let _e = 0; _e < R; _e++) {
      const o = ot(v);
      if (!o) {
        h(de.INVALID_UNICODE_ESCAPE_SEQUENCE, s(), 0, `\\${y}${Y}${v.currentChar()}`);
        break;
      }
      Y += o;
    }
  ...
  function xe(v, y) {
    ...
    switch (v.currentChar()) {
      case "{":
        return y.braceNest >= 1 && h(de.NOT_ALLOW_NEST_PLACEHOLDER, s(), 0), v.next(), R = p(
          y,
          2,
          "{"
      ...
      case "}":
        return y.braceNest > 0 && y.currentType === 2 && h(de.EMPTY_PLACEHOLDER, s(), 0), v.next(), R = p(
          y,
          3,
          "}"
      ...
      case "@":
        return y.braceNest > 0 && h(de.UNTERMINATED_CLOSING_BRACE, s(), 0), R = ht(v, y) || x(y), y.braceNest = 0, R;
      default: {
        let _e = !0, o = !0, a = !0;
        if (U(v))
          return y.braceNest > 0 && h(de.UNTERMINATED_CLOSING_BRACE, s(), 0), R = p(y, 1, Ot(v)), y.braceNest = 0, y.inLinked = !1, R;
        if (y.braceNest > 0 && (y.currentType === 4 || y.currentType === 5 || y.currentType === 6))
          return h(de.UNTERMINATED_CLOSING_BRACE, s(), 0), y.braceNest = 0, rt(v, y);
        if (_e = I(v, y))
        ...
        if (!_e && !o && !a)
          return R = p(y, 12, mt(v)), h(de.INVALID_TOKEN_IN_PLACEHOLDER, s(), 0, R.value), P(v), R;
        break;
      }
    }
    return R;
  ...
  function ht(v, y) {
    ...
    switch ((R === 7 || R === 8 || R === 11 || R === 9) && (_e === Me || _e === ct) && h(de.INVALID_LINKED_FORMAT, s(), 0), _e) {
      case "@":
        return v.next(), Y = p(
          y,
          7,
      ...
      default:
        return U(v) ? (Y = p(y, 1, Ot(v)), y.braceNest = 0, y.inLinked = !1, Y) : q(v, y) || J(v, y) ? (P(v), ht(v, y)) : $(v, y) ? (P(v), p(y, 11, pt(v))) : G(v, y) ? (P(v), _e === "{" ? xe(v, y) || Y : p(y, 10, on(v))) : (R === 7 && h(de.INVALID_LINKED_FORMAT, s(), 0), y.braceNest = 0, y.inLinked = !1, rt(v, y));
    }
  }
  function rt(v, y) {
    let R = {
    ...
    switch (v.currentChar()) {
      case "{":
        return xe(v, y) || x(y);
      case "}":
        return h(de.UNBALANCED_CLOSING_BRACE, s(), 0), v.next(), p(
          y,
          3,
          "}"
          /* TokenChars.BraceRight */
...
function Fa(e = {}) {
  ...
  function b(g) {
    ...
    return T.type !== 11 ? (i(g, de.UNEXPECTED_EMPTY_LINKED_MODIFIER, I.lastStartLoc, 0), q.value = "", s(q, E, F), {
      nextConsumeToken: T,
      node: q
    }) : (T.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, I.lastStartLoc, 0, Ze(T)), q.value = T.value || "", s(q, g.currentOffset(), g.currentPosition()), {
      node: q
    });
  }
  function h(g, T) {
  ...
  function p(g) {
    ...
    switch (E.type !== 9 && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(E)), E = g.nextToken(), E.type === 2 && (E = g.nextToken()), E.type) {
      case 10:
        E.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(E)), I.key = h(g, E.value || "");
        break;
      case 4:
        E.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(E)), I.key = f(g, E.value || "");
        break;
      case 5:
        E.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(E)), I.key = u(g, E.value || "");
        break;
      case 6:
        E.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(E)), I.key = d(g, E.value || "");
        break;
      default: {
        i(g, de.UNEXPECTED_EMPTY_LINKED_KEY, T.lastStartLoc, 0);
  ...
  function x(g) {
    ...
    do {
      ...
      switch (q = null, G.type) {
        case 0:
          G.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(G)), F.items.push(l(g, G.value || ""));
          break;
        case 5:
          G.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(G)), F.items.push(u(g, G.value || ""));
          break;
        case 4:
          G.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(G)), F.items.push(f(g, G.value || ""));
          break;
        case 6:
          G.value == null && i(g, de.UNEXPECTED_LEXICAL_ANALYSIS, T.lastStartLoc, 0, Ze(G)), F.items.push(d(g, G.value || ""));
          break;
        case 7: {
          const U = p(g);
    ...
    const $ = T.currentType === 1 ? T.lastOffset : g.currentOffset(), J = T.currentType === 1 ? T.lastEndLoc : g.currentPosition();
    return s(F, $, J), F;
  }
  function k(g, T, I, E) {
    const F = g.context();
    ...
    return q && i(g, de.MUST_HAVE_MESSAGES_IN_PLURAL, I, 0), s($, g.currentOffset(), g.currentPosition()), $;
  }
  function S(g) {
  ...
  function P(g) {
    ...
    return t && E.loc && (E.loc.source = g), E.body = S(T), e.onCacheKey && (E.cacheKey = e.onCacheKey(g)), I.currentType !== 13 && i(T, de.UNEXPECTED_LEXICAL_ANALYSIS, I.lastStartLoc, 0, g[I.offset] || ""), s(E, T.currentOffset(), T.currentPosition()), E;
  }
  return { parse: P };
}
function Ze(e) {
...
function ji(e, t) {
  ...
  {
    const i = Qa(t).reduce((r, s) => [...r, si(e, s)], []);
...
function si(e, t) {
  ...
  switch (n) {
    ...
    case 6: {
      ...
      return e.linked(si(e, s), r ? si(e, r) : void 0, e.type);
    }
    case 7:
      return Ln(t, n);
    case 8:
...
function nr(e, t, n) {
  ...
  if (!s) {
    ...
    for (; Ee(l); )
      l = Gi(s, l, t);
    const u = Ee(t) || !ee(t) ? t : t.default ? t.default : null;
...
function _s(e) {
  ...
  for (; i !== null; )
    if (n++, s = e[n], !(s === "\\" && x())) {
      if (f = vs(s), h = Lt[i], d = h[f] || h.l || 8, d === 8 || (i = d[0], d[1] !== void 0 && (b = p[d[1]], b && (u = s, b() === !1))))
        return;
      if (i === 7)
        return t;
    }
...
const xs = "11.1.3", jn = -1, gn = "en-US", Ji = "", Zi = (e) => `${e.charAt(0).toLocaleUpperCase()}${e.substr(1)}`;
function ks() {
  return {
...
let eo = 0;
function Ls(e = {}) {
  const t = ve(e.onWarn) ? e.onWarn : Ta, n = W(e.version) ? e.version : xs, i = W(e.locale) || ve(e.locale) ? e.locale : gn, r = ve(i) ? gn : i, s = Ee(e.fallbackLocale) || ee(e.fallbackLocale) || W(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : r, l = ee(e.messages) ? e.messages : ei(r), u = ee(e.datetimeFormats) ? e.datetimeFormats : ei(r), f = ee(e.numberFormats) ? e.numberFormats : ei(r), d = Ae(me(), e.modifiers, ks()), b = e.pluralRules || me(), h = ve(e.missing) ? e.missing : null, p = le(e.missingWarn) || Jt(e.missingWarn) ? e.missingWarn : !0, x = le(e.fallbackWarn) || Jt(e.fallbackWarn) ? e.fallbackWarn : !0, k = !!e.fallbackFormat, S = !!e.unresolving, P = ve(e.postTranslation) ? e.postTranslation : null, g = ee(e.processor) ? e.processor : null, T = le(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, I = !!e.escapeParameter, E = ve(e.messageCompiler) ? e.messageCompiler : ir, F = ve(e.messageResolver) ? e.messageResolver : or || bs, q = ve(e.localeFallbacker) ? e.localeFallbacker : rr || us, $ = ce(e.fallbackContext) ? e.fallbackContext : void 0, J = e, G = ce(J.__datetimeFormatters) ? J.__datetimeFormatters : /* @__PURE__ */ new Map(), U = ce(J.__numberFormatters) ? J.__numberFormatters : /* @__PURE__ */ new Map(), se = ce(J.__meta) ? J.__meta : {};
  eo++;
  const K = {
    version: n,
    cid: eo,
...
function to(e, ...t) {
  const { datetimeFormats: n, unresolving: i, fallbackLocale: r, onWarn: s, localeFallbacker: l } = e, { __datetimeFormatters: u } = e, [f, d, b, h] = li(...t), p = le(b.missingWarn) ? b.missingWarn : e.missingWarn;
  ...
  if (!W(f) || f === "")
    return new Intl.DateTimeFormat(k, h).format(d);
  let P = {}, g, T = null;
  ...
  if (!ee(T) || !W(g))
    return i ? jn : f;
  let E = `${g}__${f}`;
  Un(h) || (E = `${E}__${JSON.stringify(h)}`);
  let F = u.get(E);
  return F || (F = new Intl.DateTimeFormat(g, Ae({}, T, h)), u.set(E, F)), x ? F.formatToParts(d) : F.format(d);
}
const lr = [
  "localeMatcher",
  "weekday",
...
function li(...e) {
  ...
  }), W(i) ? s.locale = i : ee(i) && (l = i), ee(r) && (l = r), [s.key || "", u, s, l];
}
function no(e, t, n) {
  const i = e;
  for (const r in n) {
...
function io(e, ...t) {
  const { numberFormats: n, unresolving: i, fallbackLocale: r, onWarn: s, localeFallbacker: l } = e, { __numberFormatters: u } = e, [f, d, b, h] = ci(...t), p = le(b.missingWarn) ? b.missingWarn : e.missingWarn;
  le(b.fallbackWarn) ? b.fallbackWarn : e.fallbackWarn;
  const x = !!b.part, k = Ci(e, b), S = l(
    e,
    // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  if (!W(f) || f === "")
    return new Intl.NumberFormat(k, h).format(d);
  let P = {}, g, T = null;
  ...
  Un(h) || (E = `${E}__${JSON.stringify(h)}`);
  let F = u.get(E);
  return F || (F = new Intl.NumberFormat(g, Ae({}, T, h)), u.set(E, F)), x ? F.formatToParts(d) : F.format(d);
}
const cr = [
  "localeMatcher",
  "style",
...
function Bs(e = {}) {
  const t = e.locale, n = Fs(e), i = ce(e.pluralRules) && W(t) && ve(e.pluralRules[t]) ? e.pluralRules[t] : ro, r = ce(e.pluralRules) && W(t) && ve(e.pluralRules[t]) ? ro : void 0, s = (g) => g[i(n, g.length, r)], l = e.list || [], u = (g) => l[g], f = e.named || me();
  ...
  const h = (g) => e.modifiers ? e.modifiers[g] : Is, p = ee(e.processor) && ve(e.processor.normalize) ? e.processor.normalize : Ds, x = ee(e.processor) && ve(e.processor.interpolate) ? e.processor.interpolate : Ms, k = ee(e.processor) && W(e.processor.type) ? e.processor.type : Rs, P = {
    list: u,
    named: d,
    plural: s,
    linked: (g, ...T) => {
...
const ao = () => "", Ve = (e) => ve(e);
function so(e, ...t) {
  const { fallbackFormat: n, postTranslation: i, unresolving: r, messageCompiler: s, fallbackLocale: l, messages: u } = e, [f, d] = di(...t), b = le(d.missingWarn) ? d.missingWarn : e.missingWarn, h = le(d.fallbackWarn) ? d.fallbackWarn : e.fallbackWarn, p = le(d.escapeParameter) ? d.escapeParameter : e.escapeParameter, x = !!d.resolvedMessage, k = W(d.default) || le(d.default) ? le(d.default) ? s ? f : () => f : d.default : n ? s ? f : () => f : null, S = n || k != null && (W(k) || ve(k)), P = Ci(e, d);
  p && zs(d);
  let [g, T, I] = x ? [
    f,
    P,
    u[P] || me()
  ] : dr(e, f, P, l, h, b), E = g, F = f;
...
function dr(e, t, n, i, r, s) {
  ...
  let h = me(), p, x = null;
  const k = "translate";
  for (let S = 0; S < b.length && (p = b[S], h = l[p] || me(), (x = f(h, t)) === null && (x = h[t]), !(W(x) || et(x) || Ve(x))); S++)
    if (!$s(p, b)) {
      const P = Pi(
        e,
        // eslint-disable-line @typescript-eslint/no-explicit-any
...
function di(...e) {
  ...
  return Se(n) ? r.plural = n : W(n) ? r.default = n : ee(n) && !Un(n) ? r.named = n : Ee(n) && (r.list = n), Se(i) ? r.plural = i : W(i) ? r.default = i : ee(i) && Ae(r, i), [s, r];
}
...
const ui = /* @__PURE__ */ Pt("__translateVNode"), fi = /* @__PURE__ */ Pt("__datetimeParts"), mi = /* @__PURE__ */ Pt("__numberParts"), fr = Pt("__setPluralRules"), mr = /* @__PURE__ */ Pt("__injectWithOption"), pi = /* @__PURE__ */ Pt("__dispose");
function vn(e) {
  if (!ce(e) || et(e))
    return e;
  for (const t in e)
...
function Li(e = {}) {
  const { __root: t, __injectWithOption: n } = e, i = t === void 0, r = e.flatJson, s = qn ? ae : Yr;
  ...
  const u = s(
    ...
    // prettier-ignore
    t && l ? t.fallbackLocale.value : W(e.fallbackLocale) || Ee(e.fallbackLocale) || ee(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : u.value
  ), d = s(Ai(u.value, e)), b = s(ee(e.datetimeFormats) ? e.datetimeFormats : { [u.value]: {} }), h = s(ee(e.numberFormats) ? e.numberFormats : { [u.value]: {} });
  let p = t ? t.missingWarn : le(e.missingWarn) || Jt(e.missingWarn) ? e.missingWarn : !0, x = t ? t.fallbackWarn : le(e.fallbackWarn) || Jt(e.fallbackWarn) ? e.fallbackWarn : !0, k = t ? t.fallbackRoot : le(e.fallbackRoot) ? e.fallbackRoot : !0, S = !!e.fallbackFormat, P = ve(e.missing) ? e.missing : null, g = ve(e.missing) ? mo(e.missing) : null, T = ve(e.postTranslation) ? e.postTranslation : null, I = t ? t.warnHtmlMessage : le(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, E = !!e.escapeParameter;
  ...
  $ = (() => {
    ...
    a.datetimeFormats = b.value, a.numberFormats = h.value, a.__datetimeFormatters = ee($) ? $.__datetimeFormatters : void 0, a.__numberFormatters = ee($) ? $.__numberFormatters : void 0;
    const c = Ls(a);
    return i && Qi(c), c;
  })(), sn($, u.value, f.value);
  function G() {
  ...
  }), K = be(() => d.value), Te = /* @__PURE__ */ be(() => b.value), we = /* @__PURE__ */ be(() => h.value);
  function $e() {
    return ve(T) ? T : null;
  }
  function pe(a) {
  ...
  const ye = (a, c, m, _, A, L) => {
    ...
    Se(O) && O === jn || m === "translate exists" && !O) {
      const [V, H] = c();
      return t && k ? _(t) : A(V);
    } else {
      if (L(O))
  ...
  function ot(...a) {
    return ye((c) => Reflect.apply(so, null, [c, ...a]), () => di(...a), "translate", (c) => Reflect.apply(c.t, c, [...a]), (c) => c, (c) => W(c));
  }
  function Ht(...a) {
    const [c, m, _] = a;
    if (_ && !ce(_))
  ...
  function Qt(...a) {
    return ye((c) => Reflect.apply(to, null, [c, ...a]), () => li(...a), "datetime format", (c) => Reflect.apply(c.d, c, [...a]), () => Ji, (c) => W(c));
  }
  function Wt(...a) {
    return ye((c) => Reflect.apply(io, null, [c, ...a]), () => ci(...a), "number format", (c) => Reflect.apply(c.n, c, [...a]), () => Ji, (c) => W(c));
  }
  function en(a) {
  ...
  function tn(...a) {
    return ye((c) => {
      ...
      return m;
    }, () => di(...a), "translate", (c) => c[ui](...a), (c) => [lo(c)], (c) => Ee(c));
  }
  function Ut(...a) {
    return ye((c) => Reflect.apply(io, null, [c, ...a]), () => ci(...a), "number format", (c) => c[mi](...a), uo, (c) => W(c) || Ee(c));
  }
  function nn(...a) {
    return ye((c) => Reflect.apply(to, null, [c, ...a]), () => li(...a), "datetime format", (c) => c[fi](...a), uo, (c) => W(c) || Ee(c));
  }
  function mt(a) {
    q = a, $.pluralRules = q;
  }
  ...
  function Y(a, c) {
    h.value[a] = c, $.numberFormats = h.value, oo($, a, c);
  }
  function _e(a, c) {
    h.value[a] = Ae(h.value[a] || {}, c), $.numberFormats = h.value, oo($, a, c);
  }
  fo++, t && qn && (qe(t.locale, (a) => {
  ...
  return o.datetimeFormats = Te, o.numberFormats = we, o.rt = Ht, o.te = pt, o.tm = Ot, o.d = Qt, o.n = Wt, o.getDateTimeFormat = rn, o.setDateTimeFormat = v, o.mergeDateTimeFormat = y, o.getNumberFormat = R, o.setNumberFormat = Y, o.mergeNumberFormat = _e, o[mr] = n, o[ui] = tn, o[fi] = nn, o[mi] = Ut, o;
}
function Gs(e) {
  const t = W(e.locale) ? e.locale : gn, n = W(e.fallbackLocale) || Ee(e.fallbackLocale) || ee(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : t, i = ve(e.missing) ? e.missing : void 0, r = le(e.silentTranslationWarn) || Jt(e.silentTranslationWarn) ? !e.silentTranslationWarn : !0, s = le(e.silentFallbackWarn) || Jt(e.silentFallbackWarn) ? !e.silentFallbackWarn : !0, l = le(e.fallbackRoot) ? e.fallbackRoot : !0, u = !!e.formatFallbackMessages, f = ee(e.modifiers) ? e.modifiers : {}, d = e.pluralizationRules, b = ve(e.postTranslation) ? e.postTranslation : void 0, h = W(e.warnHtmlInMessage) ? e.warnHtmlInMessage !== "off" : !0, p = !!e.escapeParameterHtml, x = le(e.sync) ? e.sync : !0;
  let k = e.messages;
...
const Zs = /* @__PURE__ */ Bt({
  ...
  setup(e, t) {
    ...
    return () => {
      const s = Object.keys(n).filter((h) => h !== "_"), l = me();
      e.locale && (l.locale = e.locale), e.plural !== void 0 && (l.plural = W(e.plural) ? +e.plural : e.plural);
      const u = Js(t, s), f = r[ui](e.keypath, u, l), d = Ae(me(), i), b = W(e.tag) || ce(e.tag) ? e.tag : gr();
      return zo(b, d, f);
    };
  }
}), ho = Zs;
...
function vr(e, t, n, i) {
  ...
  return () => {
    ...
    const b = Ae(me(), s), h = W(e.tag) || ce(e.tag) ? e.tag : gr();
    return zo(h, b, d);
  };
}
...
function nl(e) {
  ...
  return {
    created: (l, u) => {
      const [f, d] = t(u);
      qn && e.global === d && (l.__i18nWatcher = qe(d.locale, () => {
        u.instance && u.instance.$forceUpdate();
      })), l.__composer = d, l.textContent = f;
    },
    unmounted: (l) => {
      qn && l.__i18nWatcher && (l.__i18nWatcher(), l.__i18nWatcher = void 0, delete l.__i18nWatcher), l.__composer && (l.__composer = void 0, delete l.__composer);
    },
...
function rl(e = {}) {
  ...
  const b = {
    ...
    // install plugin
    async install(h, ...p) {
      if (h.__VUE_I18N_SYMBOL__ = l, h.provide(h.__VUE_I18N_SYMBOL__, b), ee(p[0])) {
        const S = p[0];
        b.__composerExtend = S.__composerExtend, b.__vueI18nExtend = S.__vueI18nExtend;
      }
      let x = null;
      !t && n && (x = pl(h, b.global)), __VUE_I18N_FULL_INSTALL__ && il(h, b, ...p), __VUE_I18N_LEGACY_API__ && t && h.mixin(Ks(s, s.__composer, b));
      const k = h.unmount;
      h.unmount = () => {
        x && x(), b.dispose(), k();
      };
...
function Ce(e = {}) {
  ...
  if (u == null) {
    const f = Ae({}, e);
    "__i18n" in r && (f.__i18n = r.__i18n), i && (f.__root = i), u = Li(f), l.__composerExtend && (u[pi] = l.__composerExtend(u)), fl(l, t, u), l.__setInstance(t, u);
  }
  return u;
}
function al(e, t) {
...
}), cn = "choose_accommodation", yr = "empty_cart", Rn = "booking_confirmation", wo = "reservation_details", ti = "cancel_reservation", kn = (e, t) => {
...
function Al(e, t, n = 60) {
  ...
  const b = new Date(f);
  for (; b <= d; ) {
    const h = b.getHours().toString().padStart(2, "0"), p = b.getMinutes().toString().padStart(2, "0");
    i.push(`${h}:${p}`), b.setMinutes(b.getMinutes() + n);
  }
  return i;
}
function Ll(e) {
  ...
  return xo || (xo = 1, function(e, t) {
    (function(n, i) {
      ...
      function h(o) {
        ...
        function Z(te) {
          U(m) && m.call(j, te, this), O && Z.destroy();
        }
      ...
      function P(o) {
        ...
        d(_, function(A) {
          p(o, "g" + A);
        }), h(m, { onElement: o, avoidDuplicate: !1, once: !0, withCallback: function(A, L) {
          d(_, function(O) {
            x(L, "g" + O);
          }), U(c) && c();
        } });
      ...
      function Ht(o) {
        ...
        o.events.keyboard = h("keydown", { onElement: window, withCallback: function(a, c) {
      ...
      function tn(o, a, c, m) {
        ...
        L.style.height = a.height, L.style.width = a.width, L.appendChild(_), this.events["inlineclose" + O] = h("click", { onElement: L.querySelectorAll(".gtrigger-close"), withCallback: function(Z) {
      ...
      var nn = r(function o() {
        ...
        if (O === "a" && (A = o.href), O === "img" && (A = o.src, m.alt = o.alt), m.href = A, d(m, function(te, ne) {
          ...
          d(m, function(te, ne) {
            j.push(";\\s?" + ne);
          }), j = j.join("\\s?:|"), L.trim() !== "" && d(m, function(te, ne) {
        ...
        var L = _.type, O = _.descPosition, V = a.querySelector(".gslide-media"), H = a.querySelector(".gslide-title"), j = a.querySelector(".gslide-desc"), X = a.querySelector(".gdesc-inner"), Z = c, te = "gSlideTitle_" + this.index, ne = "gSlideDesc_" + this.index;
        ...
        }), _.title == "" && _.description == "" ? X && X.parentNode.parentNode.removeChild(X.parentNode) : (H && _.title !== "" ? (H.id = te, H.innerHTML = _.title) : H.parentNode.removeChild(H), j && _.description !== "" ? (j.id = ne, A && m.moreLength > 0 ? (_.smallDescription = this.slideShortDesc(_.description, m.moreLength, m.moreText), j.innerHTML = _.smallDescription, this.descriptionEvents(j, _)) : j.innerHTML = _.description) : j.parentNode.removeChild(j), p(V.parentNode, "desc-".concat(O)), p(X.parentNode, "description-".concat(O))), p(V, "gslide-".concat(L)), p(a, "loaded"), L !== "video") {
        ...
        if (!m) return !1;
        h("click", { onElement: m, withCallback: function(_, A) {
          _.preventDefault();
          var L = document.body, O = S(A, ".gslide-desc");
          if (!O) return !1;
          O.innerHTML = a.description, p(L, "gdesc-open");
          var V = h("click", { onElement: [L, S(O, ".gslide-description")], withCallback: function(H, j) {
      ...
      function rt(o) {
        ...
        c > 769 && (m = _), p(m, "greset"), g(m, "translate3d(0, 0, 0)"), h(a, { onElement: m, once: !0, withCallback: function(L, O) {
          x(m, "greset");
        } }), m.style.opacity = "", A && (A.style.opacity = "");
      }
      function rn(o) {
        if (o.events.hasOwnProperty("touch")) return !1;
        var a, c, m, _ = F(), A = _.width, L = _.height, O = !1, V = null, H = null, j = null, X = !1, Z = 1, te = 1, ne = !1, ke = !1, We = null, ze = null, at = null, Ne = null, st = 0, lt = 0, an = !1, Yt = !1, Ke = {}, Je = {}, qi = 0, Bi = 0, Br = document.getElementById("glightbox-slider"), Cn = document.querySelector(".goverlay"), zr = new ht(Br, { touchStart: function(he) {
    ...
    <button class="gnext gbtn" aria-label="Next" data-taborder="1">{nextSVG}</button>
        ...
        a && (this.baseEvents = h("click", { onElement: a, withCallback: function(c, m) {
        ...
        this.prevButton = O.querySelector(".gprev"), this.nextButton = O.querySelector(".gnext"), this.overlay = O.querySelector(".goverlay"), this.loader = O.querySelector(".gloader"), this.slidesContainer = document.getElementById("glightbox-slider"), this.bodyHiddenChildElms = c, this.events = {}, p(this.modal, "glightbox-" + this.settings.skin), this.settings.closeButton && V && (this.events.close = h("click", { onElement: V, withCallback: function(H, j) {
          H.preventDefault(), o.close();
        } })), V && !this.settings.closeButton && V.parentNode.removeChild(V), this.nextButton && (this.events.next = h("click", { onElement: this.nextButton, withCallback: function(H, j) {
          H.preventDefault(), o.nextSlide();
        } })), this.prevButton && (this.events.prev = h("click", { onElement: this.prevButton, withCallback: function(H, j) {
          H.preventDefault(), o.prevSlide();
        } })), this.settings.closeOnOutsideClick && (this.events.outClose = h("click", { onElement: O, withCallback: function(H, j) {
        ...
        }), y && p(document.body, "glightbox-touch"), this.events.resize = h("resize", { onElement: window, withCallback: function() {
          o.resize();
        } }), this.built = !0;
          ...
          if (A <= 768 ? p(document.body, "glightbox-mobile") : x(document.body, "glightbox-mobile"), c || m) {
            ...
            if (_ && (k(_, "description-bottom") || k(_, "description-top")) && !k(_, "gabsolute") && (O = !0), m) {
              if (A <= 768) m.querySelector("img");
                ...
                var V, H, j = _.offsetHeight, X = m.querySelector("img"), Z = (V = this.elements[this.index]) === null || V === void 0 ? void 0 : V.node, te = "100vh";
                Z && (te = (H = Z.getAttribute("data-height")) !== null && H !== void 0 ? H : te), X.setAttribute("style", "max-height: calc(".concat(te, " - ").concat(j, "px)")), _.setAttribute("style", "max-width: ".concat(X.offsetWidth, "px;"));
              }
            }
            if (c) {
    ...
    return (r, s) => (C(), D("article", Dl, [
      w("section", {
        ...
        N(Rl, {
          ...
          default: B(() => [
            e.data.thumbnail && e.data.thumbnail.url ? (C(), D("img", {
              key: 0,
              onClick: i,
              src: e.data.thumbnail.url,
              alt: e.data.thumbnail.name
            }, null, 8, Ml)) : (C(), D("span", Fl, M(z(t)("accommodationType.thumbnail")), 1))
          ]),
          _: 1
        }, 8, ["modelValue", "images"])
      ]),
      w("section", ql, [
        w("div", Bl, [
          ...
          w("div", zl, [
            (C(!0), D(ue, null, Oe(e.data.amenities, (l, u) => (C(), D("span", {
              key: u,
...
function wr(e, t, n) {
  ...
  return t.reference[s] > t.floating[s] && (l = Hn(l)), [l, Hn(l)];
}
function Yl(e) {
  const t = Hn(e);
  return [zn(e), t, zn(t)];
...
function Xl(e, t, n, i) {
  ...
  return r && (s = s.map((l) => l + "-" + r), t && (s = s.concat(s.map(zn)))), s;
}
function Hn(e) {
...
function So(e, t, n) {
  ...
  const s = qt(t), l = Ii(t), u = $i(l), f = it(t), d = s === "y", b = i.x + i.width / 2 - r.width / 2, h = i.y + i.height / 2 - r.height / 2, p = i[u] / 2 - r[u] / 2;
  let x;
  switch (f) {
    case "top":
      x = {
...
async function Xn(e, t) {
  ...
  const {
    ...
    altBoundary: p = !1,
    padding: x = 0
  } = zt(t, e), k = xr(x), P = u[p ? h === "floating" ? "reference" : "floating" : h], g = dn(await s.getClippingRect({
...
const Jl = (e) => ({
  ...
  async fn(t) {
    ...
    const h = xr(b), p = {
      x: n,
      y: i
    }, x = Ii(r), k = $i(x), S = await l.getDimensions(d), P = x === "y", g = P ? "top" : "left", T = P ? "bottom" : "right", I = P ? "clientHeight" : "clientWidth", E = s.reference[k] + s.reference[x] - p[x] - s.floating[k], F = p[x] - s.reference[x], q = await (l.getOffsetParent == null ? void 0 : l.getOffsetParent(d));
    let $ = q ? q[I] : 0;
    (!$ || !await (l.isElement == null ? void 0 : l.isElement(q))) && ($ = u.floating[I] || s.floating[k]);
    const J = E / 2 - F / 2, G = $ / 2 - S[k] / 2 - 1, U = yn(h[g], G), se = yn(h[T], G), K = U, Te = $ - S[k] - se, we = $ / 2 - S[k] / 2 + J, $e = gi(K, we, Te), pe = !f.arrow && Xe(r) != null && we !== $e && s.reference[k] / 2 - (we < K ? U : se) - S[k] / 2 < 0, oe = pe ? we < K ? we - K : we - Te : 0;
    return {
      [x]: p[x] + oe,
      data: {
        [x]: $e,
...
function Zl(e, t, n) {
  return (e ? [...n.filter((r) => Xe(r) === e), ...n.filter((r) => Xe(r) !== e)] : n.filter((r) => it(r) === r)).filter((r) => e ? Xe(r) === e || (t ? zn(r) !== r : !1) : !0);
}
const Ql = function(e) {
  return e === void 0 && (e = {}), {
    name: "autoPlacement",
    ...
    async fn(t) {
      ...
      const {
        ...
        autoAlignment: x = !0,
        ...k
      } = zt(e, t), S = h !== void 0 || p === To ? Zl(h || null, x, p) : p, P = await Xn(t, k), g = ((n = l.autoPlacement) == null ? void 0 : n.index) || 0, T = S[g];
      if (T == null)
        return {};
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const g = it(r), T = qt(u), I = it(u) === u, E = await (f.isRTL == null ? void 0 : f.isRTL(d.floating)), F = p || (I || !S ? [Hn(u)] : Yl(u)), q = k !== "none";
      !p && q && F.push(...Xl(u, S, k, E));
      const $ = [u, ...F], J = await Xn(t, P), G = [];
      ...
      if (U = [...U, {
        ...
        var se, K;
        const we = (((se = s.flip) == null ? void 0 : se.index) || 0) + 1, $e = $[we];
        if ($e)
          return {
            data: {
              index: we,
...
async function tc(e, t) {
  const {
    ...
    platform: i,
    elements: r
  } = e, s = await (i.isRTL == null ? void 0 : i.isRTL(r.floating)), l = it(n), u = Xe(n), f = qt(n) === "y", d = ["left", "top"].includes(l) ? -1 : 1, b = s && f ? -1 : 1, h = zt(t, e);
  let {
    mainAxis: p,
    crossAxis: x,
    alignmentAxis: k
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: i
      }, b = await Xn(t, f), h = qt(it(r)), p = br(h);
      let x = d[p], k = d[h];
      if (s) {
        const P = p === "y" ? "top" : "left", g = p === "y" ? "bottom" : "right", T = x + b[P], I = x - b[g];
        x = gi(T, x, I);
      }
      if (l) {
        const P = h === "y" ? "top" : "left", g = h === "y" ? "bottom" : "right", T = k + b[P], I = k - b[g];
        k = gi(T, k, I);
      }
      const S = u.fn({
        ...t,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        ...d
      } = zt(e, t), b = await Xn(t, d), h = it(r), p = Xe(r), x = qt(r) === "y", {
        width: k,
        height: S
      } = s.floating;
      let P, g;
      h === "top" || h === "bottom" ? (P = h, g = p === (await (l.isRTL == null ? void 0 : l.isRTL(u.floating)) ? "start" : "end") ? "left" : "right") : (g = h, P = p === "end" ? "top" : "bottom");
      const T = S - b.top - b.bottom, I = k - b.left - b.right, E = yn(S - b[P], T), F = yn(k - b[g], I), q = !t.middlewareData.shift;
      let $ = E, J = F;
...
const Eo = Math.min, un = Math.max, Wn = Math.round;
function kr(e) {
  const t = tt(e);
  let n = parseFloat(t.width), i = parseFloat(t.height);
  const r = e.offsetWidth, s = e.offsetHeight, l = Wn(n) !== r || Wn(i) !== s;
...
function Gt(e) {
  ...
  let l = (s ? Wn(n.width) : n.width) / i, u = (s ? Wn(n.height) : n.height) / r;
...
function _n(e, t, n, i) {
  ...
  let h = (l.left + (b && ((r = d.visualViewport) == null ? void 0 : r.offsetLeft) || 0)) / f.x, p = (l.top + (b && ((s = d.visualViewport) == null ? void 0 : s.offsetTop) || 0)) / f.y, x = l.width / f.x, k = l.height / f.y;
  if (u) {
    const S = Ue(u), P = i && bt(i) ? Ue(i) : i;
    let g = S.frameElement;
    for (; g && i && P !== S; ) {
      const T = Gt(g), I = g.getBoundingClientRect(), E = getComputedStyle(g);
      I.x += (g.clientLeft + parseFloat(E.paddingLeft)) * T.x, I.y += (g.clientTop + parseFloat(E.paddingTop)) * T.y, h *= T.x, p *= T.y, x *= T.x, k *= T.y, h += I.x, p += I.y, g = Ue(g).frameElement;
    }
  }
  return { width: x, height: k, top: p, right: h + x, bottom: p + k, left: h, x: h, y: p };
}
function wt(e) {
...
function Ar(e) {
  return _n(wt(e)).left + Kn(e).scrollLeft;
}
function bn(e) {
...
function Lr(e) {
  const t = bn(e);
  return Ni(t) ? t.ownerDocument.body : nt(t) && Gn(t) ? t : Lr(t);
}
function Vn(e, t) {
  var n;
  t === void 0 && (t = []);
  const i = Lr(e), r = i === ((n = e.ownerDocument) == null ? void 0 : n.body), s = Ue(i);
  return r ? t.concat(s, s.visualViewport || [], Gn(i) ? i : []) : t.concat(i, Vn(i));
}
function Po(e, t, n) {
  return t === "viewport" ? dn(function(i, r) {
    const s = Ue(i), l = wt(i), u = s.visualViewport;
    let f = l.clientWidth, d = l.clientHeight, b = 0, h = 0;
    if (u) {
      f = u.width, d = u.height;
      const p = Er();
      (p || !p && r === "fixed") && (b = u.offsetLeft, h = u.offsetTop);
    }
    return { width: f, height: d, x: b, y: h };
    ...
    const r = wt(i), s = Kn(i), l = i.ownerDocument.body, u = un(r.scrollWidth, r.clientWidth, l.scrollWidth, l.clientWidth), f = un(r.scrollHeight, r.clientHeight, l.scrollHeight, l.clientHeight);
...
function Lo(e) {
  ...
  return n && (xt(n) === "html" || xt(n) === "body" && tt(n).position === "static" && !vi(n)) ? t : n || function(i) {
    let r = bn(i);
    for (; nt(r) && !Ni(r); ) {
      if (vi(r)) return r;
      r = bn(r);
...
function ac(e, t, n) {
  ...
  const u = { x: 0, y: 0 };
  if (i || !i && n !== "fixed") if ((xt(t) !== "body" || Gn(r)) && (l = Kn(t)), nt(t)) {
    const f = _n(t, !0);
...
const sc = { getClippingRect: function(e) {
  ...
  const s = n === "clippingAncestors" ? function(d, b) {
    const h = b.get(d);
    if (h) return h;
    let p = Vn(d).filter((P) => bt(P) && xt(P) !== "body"), x = null;
    const k = tt(d).position === "fixed";
    let S = k ? bn(d) : d;
    for (; bt(S) && !Ni(S); ) {
      const P = tt(S), g = vi(S);
      (k ? g || x : g || P.position !== "static" || !x || !["absolute", "fixed"].includes(x.position)) ? x = P : p = p.filter((T) => T !== S), S = bn(S);
    }
    return b.set(d, p), p;
  }(t, this._c) : [].concat(n), l = [...s, i], u = l[0], f = l.reduce((d, b) => {
    const h = Po(t, b, r);
    return d.top = un(h.top, d.top), d.right = Eo(h.right, d.right), d.bottom = Eo(h.bottom, d.bottom), d.left = un(h.left, d.left), d;
  }, Po(t, u, r));
  ...
  const f = { x: 0, y: 0 };
  if ((r || !r && i !== "fixed") && ((xt(n) !== "body" || Gn(s)) && (l = Kn(n)), nt(n))) {
    const d = _n(n);
...
const ii = "__floating-vue__popper", $r = () => Bt({
  name: "VPopper",
  provide() {
    return {
      [ii]: {
  ...
  computed: {
    ...
    parentPopper() {
      var e;
      return (e = this[ii]) == null ? void 0 : e.parentPopper;
    },
  ...
  methods: {
    ...
    async $_applyShow(e = !1) {
      clearTimeout(this.$_disposeTimer), clearTimeout(this.$_scheduleTimer), this.skipTransition = e, !this.isShown && (this.$_ensureTeleport(), await ni(), await this.$_computePosition(), await this.$_applyShowEffect(), this.positioningDisabled || this.$_registerEventListeners([
    ...
    async $_applyShowEffect() {
      ...
      this.$emit("apply-show"), this.classes.showFrom = !0, this.classes.showTo = !1, this.classes.hideFrom = !1, this.classes.hideTo = !1, await ni(), this.classes.showFrom = !1, this.classes.showTo = !0, this.noAutoFocus || this.$_popperNode.focus();
    },
    async $_applyHide(e = !1) {
      ...
      }, t)), this.$_removeEventListeners("scroll"), this.$emit("apply-hide"), this.classes.showFrom = !1, this.classes.showTo = !1, this.classes.hideFrom = !0, this.classes.hideTo = !1, await ni(), this.classes.hideFrom = !1, this.classes.hideTo = !0;
    },
    $_autoShowHide() {
...
Jn.render = bc;
Jn.__scopeId = "data-v-b329ee4c";
Jn.__file = "src/components/ResizeObserver.vue";
const Ir = (e = "theme") => ({
  computed: {
    themeClass() {
      return cc(this[e]);
...
typeof window < "u" && (wi = window.Element);
const Pc = Bt({
  name: "VPopperWrapper",
  components: {
    Popper: gc,
...
function Ac(e, t, n, i, r, s) {
  const l = oi("PopperContent"), u = oi("Popper");
...
const Nc = { class: "price-block" }, Rc = {
  ...
  setup(e) {
    ...
    return (l, u) => (C(), D("div", Nc, [
      e.discount ? (C(), D("div", Rc, [
        w("span", Dc, [
      ...
      w("div", qc, [
        ...
        e.sellingPrice ? (C(), D("span", zc, [
          w("span", {
            class: "price-block__current-amount",
            innerHTML: r.value
          }, null, 8, Hc)
        ])) : e.sellingPrice === 0 ? (C(), D("span", Wc, M(z(n)("price.free")), 1)) : fe("", !0),
        e.sellingPrice && e.details ? (C(), D("div", Vc)) : fe("", !0)
      ]),
      w("div", Uc, [
        ge(l.$slots, "schedule")
      ])
...
const nu = { render: tu }, iu = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e) {
    const { t } = Ce();
    return (n, i) => e.kind === "adults" ? (C(), D("div", ou, [
      Fe(N(Le, {
    ...
    ])) : e.kind === "child" ? (C(), D("span", ru, M(z(t)("ratePlan.scenario.family")), 1)) : (C(), D("div", {
      key: 2,
      class: "icons",
  ...
  setup(e, { emit: t }) {
    const n = e, { t: i } = Ce(), r = ae(!1), s = ae({}), l = be(() => {
      ...
      s.value[h] || (s.value[h] = !0, u("variant-chosen", b));
    }, { formatDescription: d } = Mi();
    return (b, h) => (C(), D("div", uu, [
      w("div", fu, [
        w("div", mu, [
          w("h2", {
          ...
          w("div", pu, [
            w("div", hu, [
              ...
              N(Fn, { class: "inline" }, {
                popper: B(() => [
                  (C(!0), D(ue, null, Oe(z(d)(e.data.cancellationPolicy.consequences), (p, x) => (C(), D("p", { key: x }, M(p), 1))), 128))
                ]),
                default: B(() => [
            ...
            e.data.feed ? (C(), D("div", {
              ...
              N(Le, { name: "Restaurant" }),
              w("span", null, M(e.data.feed.name ? z(i)(`ratePlan.boardType.${e.data.feed.name}`) : ""), 1)
            ], 10, gu)) : fe("", !0),
            w("div", vu, [
              N(Le, { name: "CreditCard" }),
              w("span", null, [
                w("strong", yu, M(z(i)("ratePlan.payments")) + ":", 1),
                (C(!0), D(ue, null, Oe(e.data.paymentTypes, (p, x) => (C(), D(ue, {
                  key: p.name
                }, [
                  N(Fn, { class: "inline" }, {
                    popper: B(() => [
                    ...
                    default: B(() => [
                      w("abbr", null, M(p.name), 1)
                    ]),
                    _: 2
                  }, 1024),
                  e.data.paymentTypes.length - 1 !== x ? (C(), D("strong", _u, M(z(i)("ratePlan.or")), 1)) : fe("", !0)
                ], 64))), 128))
              ])
            ]),
            e.data.extras.length ? (C(!0), D(ue, { key: 1 }, Oe(e.data.extras, (p, x) => (C(), D("div", {
              key: x,
      ...
      w("div", bu, [
        ge(b.$slots, "default", {}, () => [
          w("div", wu, [
            w("span", xu, M(z(i)("ratePlan.los", e.lengthOfStay)), 1),
            (C(!0), D(ue, null, Oe(e.data.variations || [], (p, x) => (C(), ie(Jc, {
              key: x,
              price: p.price
            }, {
              icons: B(() => [
            ...
            e.additionalFees.length ? (C(), D("span", ku, [
              h[3] || (h[3] = Q(" + addition fees ")),
              N(Fn, { class: "inline-flex" }, {
                popper: B(() => h[2] || (h[2] = [
                  w("p", null, "These fees will be added on the final step.", -1),
                  w("ul", null, [
                    w("li", null, [
                      w("strong", null, "City tax:"),
                      Q(" 2.5eur")
                    ])
                  ], -1)
                ])),
...
}, Su = {}, Eu = { class: "information-block__content" };
function Cu(e, t) {
  return C(), D("div", Eu, [
    ge(e.$slots, "default")
  ]);
}
const Ie = /* @__PURE__ */ kn(Su, [["render", Cu]]), Pu = { class: "rate-plan-list__wrapper" }, Au = {
      ...
      default: B(() => [
        ...
        w("div", Pu, [
          w("div", {
            ...
            (C(!0), D(ue, null, Oe(e.accommodationOffer.ratePlans, (u) => (C(), D(ue, {
              key: u.id
            }, [
              N(Pe),
              N(Tu, {
            ...
            e.accommodationOffer.ratePlans.length ? fe("", !0) : (C(), D(ue, { key: 0 }, [
              N(Pe),
              N(Ie, null, {
                default: B(() => [
                  w("p", null, [
                    ...
                    Q(M(z(n)("accommodationType.notAvailable.description")), 1)
                  ])
                ]),
                _: 1
              })
...
}, Lu = {}, Ou = { class: "information-block-grid" };
function $u(e, t) {
  return C(), D("div", Ou, [
    ge(e.$slots, "default")
  ]);
}
const Sn = /* @__PURE__ */ kn(Lu, [["render", $u]]), Iu = {
  ...
  setup(e, { emit: t }) {
    ...
    qe(
      ...
      async (h) => {
        if (!(!h.start || !h.end)) {
          s.value = !0;
          try {
            const p = await fa(h.start, h.end, n.promoCode);
    ...
    function u(h) {
      return [
        ...h.filter((p) => p.ratePlans && p.ratePlans.length > 0),
        ...h.filter((p) => !p.ratePlans || p.ratePlans.length === 0)
      ];
    }
    const f = t, d = ae(!1), b = async ({ accommodationOffer: h, ratePlan: p, variant: x }) => {
      d.value = !0;
      try {
        const k = await Vo({
          checkInDate: n.dateRange.start,
          checkOutDate: n.dateRange.end,
          accommodationType: h.accommodationType.id,
          ratePlan: p.id,
    ...
    return (h, p) => (C(), ie(Sn, null, {
      default: B(() => [
        s.value ? (C(), D(ue, { key: 0 }, Oe(3, (x) => N(Tn, { key: x })), 64)) : (C(!0), D(ue, { key: 1 }, Oe(r.value, (x) => (C(), ie(Au, {
...
}, Nu = { class: "field-decorator" }, Ru = { class: "field-decorator__input-group" }, Du = { class: "field-decorator__label" }, Mu = {
  key: 0,
  class: "field-decorator__required"
}, Fu = { class: "field-decorator__slot" }, qu = {
  key: 0,
  ...
  setup(e) {
    return (t, n) => (C(), D("div", Nu, [
      w("div", Ru, [
        w("label", Du, [
          Q(M(e.label), 1),
          e.required ? (C(), D("span", Mu, "*")) : fe("", !0)
        ]),
        w("div", Fu, [
          ge(t.$slots, "default")
        ])
      ]),
      e.hideHint ? fe("", !0) : (C(), D("div", qu, M(e.hint), 1))
    ]));
  }
}, Bu = { class: "information-block__header-additional" }, kt = {
  __name: "BflexHeader",
  props: {
    dense: {
      type: Boolean,
...
}, zu = { class: "details-info" }, Hu = { class: "details-info__icon" }, Wu = {
  ...
  setup(e) {
    return (t, n) => (C(), D("div", zu, [
      w("div", Hu, [
        e.hideIcon ? fe("", !0) : (C(), ie(Le, {
          key: 0,
          name: e.icon
        }, null, 8, ["name"]))
      ]),
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const n = e, { t: i } = Ce(), r = t, s = ri({ ...n.modelValue }), l = ri({
      firstName: "",
      lastName: "",
      email: "",
      phone: ""
    ...
    return qe(
      ...
      default: B(() => [
        N(kt, null, {
          default: B(() => [
            Q(M(z(i)("contactInformation.title")), 1)
          ]),
          _: 1
        }),
        N(Pe),
        N(Ie, null, {
          default: B(() => [
            ...
            N(Wu, { icon: "Info" }, {
              default: B(() => [
                Q(M(z(i)("contactInformation.confirmationInfo")), 1)
              ]),
              _: 1
            })
          ]),
...
}, Yu = { class: "icon-text" }, ju = { class: "icon-text__icon" }, Xu = { class: "icon-text__text" }, Xt = {
  ...
  setup(e) {
    return (t, n) => (C(), D("div", Yu, [
      w("span", ju, [
        N(Le, { name: e.icon }, null, 8, ["name"])
      ]),
      w("span", Xu, [
        ge(t.$slots, "default")
      ])
...
}, Gu = { class: "text-sm" }, Ku = { class: "accommodation-list__item" }, Ju = {
  key: 0,
  ...
  key: 0,
  class: "payment-type"
}, tf = { class: "payment-type__label" }, nf = { class: "payment-type__variants" }, of = ["for"], rf = ["name", "id", "value", "checked", "onChange"], af = { class: "accommodation-list__total" }, sf = { class: "accommodation-list__payment-rules" }, lf = { class: "highlighted" }, cf = { class: "highlighted" }, Fi = {
  ...
  setup(e, { emit: t }) {
    ...
    return Tt(() => {
      ...
      default: B(() => [
        N(kt, null, {
          default: B(() => [
            Q(M(z(i)("chosenAccommodation.title")), 1)
          ]),
          _: 1
        }),
        N(Pe),
          ...
          default: B(() => [
            w("dl", Gu, [
              w("dt", null, [
                N(Xt, { icon: "DateRange" }, {
                  default: B(() => [
                    Q(M(z(Pl)(e.reservation.checkInDate, e.reservation.checkOutDate, e.locale)), 1)
                  ]),
                  _: 1
                })
              ]),
              w("dd", null, [
                N(Xt, { icon: "Persons" }, {
                  default: B(() => [
                    Q(M(z(i)("chosenAccommodation.adults", e.reservation.adults)) + ", " + M(z(i)("chosenAccommodation.children", e.reservation.children.length)), 1)
                  ]),
                  _: 1
                })
              ])
        ...
        N(Ie, null, {
          default: B(() => [
            w("dl", Ku, [
              w("dt", null, [
                w("h3", null, [
                  Q(M(e.reservation.accommodationType.name) + " ", 1),
                  e.reservation.quantity > 1 ? (C(), D("span", Ju, "x" + M(e.reservation.quantity), 1)) : fe("", !0)
                ]),
                w("div", Zu, [
                  Q(M(e.reservation.ratePlan.name), 1),
                  b[1] || (b[1] = w("br", null, null, -1)),
                  N(Fn, { class: "inline" }, {
                    popper: B(() => [
                      (C(!0), D(ue, null, Oe(z(s)(
                        e.reservation.cancellationPolicy.consequences
                      ), (h, p) => (C(), D("p", { key: p }, M(h), 1))), 128))
                    ]),
                    default: B(() => [
              ...
              w("dd", null, [
                e.mode === "choose" ? (C(), D("div", {
                  key: 0,
                  onClick: b[0] || (b[0] = () => u(e.reservation)),
                  class: "accommodation-list__item-delete text-sm cursor-pointer"
                }, M(z(i)("chosenAccommodation.delete")), 1)) : fe("", !0),
                e.reservation.quantity > 1 ? (C(), D("span", Qu, M(e.reservation.quantity) + " x", 1)) : fe("", !0),
                Q(" " + M(e.reservation.summary.total.amount) + " " + M(e.reservation.summary.total.currency), 1)
              ])
            ]),
            e.mode === "choose" ? (C(), D("div", ef, [
              w("div", tf, M(z(i)("chosenAccommodation.willPay")) + ":", 1),
              w("div", nf, [
                (C(!0), D(ue, null, Oe(e.reservation.availablePaymentTypes, (h) => (C(), D("label", {
                  key: h.id,
                  for: `payment-type-${d.index}-${e.reservation.ratePlan.id}-${h.id}`
                }, [
                  w("input", {
                    type: "radio",
                    name: `payment-type-${d.index}`,
                    id: `payment-type-${d.index}-${e.reservation.ratePlan.id}-${h.id}`,
                    value: e.reservation.paymentType.id,
                    checked: +e.reservation.paymentType.id == +h.id,
                    onChange: () => l(h.id)
                  }, null, 40, rf),
                  Q(" " + M(h.name), 1)
                ], 8, of))), 128))
        ...
        N(Ie, null, {
          default: B(() => [
            w("dl", af, [
              w("dt", null, M(z(i)("chosenAccommodation.totalAmount")) + ":", 1),
              w("dd", null, [
                w("strong", null, [
                  w("span", null, M(e.summary.total.amount), 1),
                  Q(" " + M(e.summary.total.currency), 1)
                ])
              ])
            ])
          ]),
        ...
        ge(d.$slots, "default", {}, () => [
          N(Ie, null, {
            default: B(() => [
              w("dl", sf, [
                w("dt", lf, M(z(i)("chosenAccommodation.prepaymentAmount")) + ":", 1),
                w("dd", cf, M(e.payment.details.prepayment.amount) + " " + M(e.payment.details.prepayment.currency), 1),
                w("dt", null, M(z(i)("chosenAccommodation.onArrivalAmount")) + ":", 1),
                w("dd", null, [
                  w("span", null, M(e.payment.details.onArrival.amount), 1),
                  Q(" " + M(e.payment.details.onArrival.currency), 1)
                ])
              ])
            ]),
            _: 1
...
}, df = { class: "summary-block" }, uf = { class: "summary-block__content" }, ff = { class: "summary-block__content-info" }, mf = { class: "summary-block__content-info__price" }, pf = { class: "summary-block__content-info__text" }, hf = {
  class: "button",
  type: "submit"
}, gf = {
  ...
  setup(e, { emit: t }) {
    const { t: n } = Ce(), i = t;
    return (r, s) => (C(), D("div", df, [
      w("div", uf, [
        w("div", ff, [
          w("div", mf, [
            w("span", null, M(e.totalAmount.amount), 1),
            Q(" " + M(e.totalAmount.currency), 1)
          ]),
          w("div", pf, [
            Q(M(z(n)("summary.room", e.accommodationUnits)) + ", " + M(z(n)("summary.los", e.lengthOfStay)) + " ", 1),
            N(Le, {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const n = e, { t: i } = Ce(), r = t, s = ri({ ...n.modelValue }), l = Al("00:00", "23:00");
    return qe(
      s,
      (u) => {
      ...
      default: B(() => [
        N(kt, null, {
          default: B(() => [
            Q(M(z(i)("specialRequest.title")), 1)
          ]),
          _: 1
        }),
        N(Pe),
        ...
        N(Ie, null, {
          default: B(() => [
            w("dl", vf, [
              w("dt", null, M(z(i)("specialRequest.checkInOutTime")) + ":", 1),
              w("dd", null, M(z(i)("specialRequest.checkInTimeFrom")) + ": " + M(e.arrivalPolicy.checkInTime) + "; " + M(z(i)("specialRequest.checkOutTimeUntil")) + ": " + M(e.arrivalPolicy.checkOutTime), 1)
            ])
          ]),
          _: 1
        }),
            ...
            N(Dt, {
              ...
              default: B(() => [
                Fe(w("select", {
                  ...
                  w("option", yf, M(z(i)("specialRequest.noneTime")), 1),
                  (C(!0), D(ue, null, Oe(z(l), (d) => (C(), D("option", {
                    value: d,
                    key: d
                  }, M(d), 9, _f))), 128))
                ], 512), [
...
}, wf = { class: "custom-checkbox" }, xf = ["required"], Bo = {
...
}, kf = { class: "agreement-rules-list__rules" }, Tf = { class: "agreement-rules-list__agreements" }, Sf = {
  key: 0,
  ...
  setup(e) {
    ...
    return (u, f) => r.value ? (C(), ie(Ge, {
      ...
      default: B(() => [
        N(kt, null, {
          default: B(() => [
            Q(M(z(n)("accommodationRules.title")), 1)
          ]),
          _: 1
        }),
        e.rules.length > 0 ? (C(), D(ue, { key: 0 }, [
          N(Pe),
          N(Ie, null, {
            default: B(() => [
              w("ul", kf, [
                (C(!0), D(ue, null, Oe(e.rules, (d, b) => (C(), D("li", { key: b }, M(d.text), 1))), 128))
              ])
            ]),
            _: 1
          })
            ...
            w("div", Tf, [
              i.value.length > 0 ? (C(), D("div", Sf, [
                N(Bo, {
                  ...
                  default: B(() => [
                    w("span", null, [
                      Q(M(z(n)("accommodationRules.agreementSentence")) + " ", 1),
                      (C(!0), D(ue, null, Oe(i.value, (d, b) => (C(), D("a", {
              ...
              (C(!0), D(ue, null, Oe(e.agreements, (d, b) => (C(), D(ue, { key: b }, [
                d.combined === !1 ? (C(), D("div", Cf, [
                  N(Bo, {
                    ...
                    default: B(() => [
                      w("span", null, [
                        Q(M(z(n)("accommodationRules.agreementSentenceShort")) + " ", 1),
                        w("a", {
                          target: "_blank",
                          href: d.url
                        }, M(d.anchor), 9, Pf)
  ...
  setup(e, { emit: t }) {
    ...
    }, p = be(() => !d.value || !d.value.requests || Object.keys(d.value.requests).length === 0 ? 0 : Object.keys(d.value.requests).reduce((P, g) => {
      const T = d.value.requests[g];
      return P + T.quantity;
...
}, Of = { class: "hotel-information" }, $f = ["href"], If = { href: "#" }, Mr = {
  ...
  setup(e) {
    ...
    return (n, i) => (C(), ie(Ge, null, {
      default: B(() => [
        N(kt, null, {
          default: B(() => [
            Q(M(z(t)("reservation.hotelInfo.title")), 1)
          ]),
          _: 1
        }),
        N(Pe),
        N(Ie, null, {
          default: B(() => [
            w("div", Of, [
              N(Xt, { icon: "Hotel" }, {
                default: B(() => [
                  Q(M(e.hotelInfo.name), 1)
                ]),
                _: 1
              }),
              N(Xt, { icon: "Home" }, {
                default: B(() => [
                  Q(M(e.hotelInfo.address.address), 1)
                ]),
                _: 1
              }),
              N(Xt, { icon: "Phone" }, {
                default: B(() => [
                  ...
                  }, M(e.hotelInfo.phone), 9, $f)
                ]),
                _: 1
              }),
              N(Xt, { icon: "Email" }, {
                default: B(() => [
                  w("a", If, M(e.hotelInfo.email), 1)
                ]),
                _: 1
              })
            ])
...
}, Nf = { class: "summary-block" }, Rf = { class: "summary-block__content" }, Df = { class: "summary-block__content-info" }, Mf = { class: "summary-block__content-info__price" }, Ff = { class: "summary-block__content-info__text" }, qf = {
    ...
    return (n, i) => (C(), D("div", Nf, [
      w("div", Rf, [
        w("div", Df, [
          ...
          w("div", Ff, [
            Q(M(z(t)("reservation.payment.prepayment")) + " ", 1),
            N(Le, {
              class: "accommodation-summary-trigger",
              name: "Info",
              small: ""
...
}, Bf = { class: "payment-timer-container" }, zf = {
  key: 0,
  class: "timer-wrapper"
}, Hf = { class: "timer-circle" }, Wf = {
  class: "timer-svg",
  width: "120",
  height: "120"
}, Vf = ["stroke-dashoffset"], Uf = { class: "timer-text" }, Yf = ["disabled"], jf = {
  key: 1,
  ...
  setup(e) {
    const t = e, n = ae(t.timeout), i = ae(null), r = 2 * Math.PI * Xf, s = ae(null), l = be(() => {
    ...
    return qe(() => t.captureToken, (x) => {
      ...
      n.value = x, t.captureToken && h();
    }), Tt(() => {
      t.captureToken && h();
    }), xn(() => {
      p();
    }), (x, k) => (C(), D("div", Bf, [
      e.captureToken ? (C(), D("div", zf, [
        w("div", Hf, [
          (C(), D("svg", Wf, [
            k[0] || (k[0] = w("circle", {
              cx: "60",
        ...
        }, M(z(u)("redirectTimer.goToPay")), 9, Yf)
      ])) : (C(), D("div", jf, [
        w("p", null, M(z(u)("redirectTimer.waitingLink")), 1)
      ]))
    ]));
  }
}, Kf = { class: "reservation-result" }, Jf = { class: "reservation-result__title" }, Zf = { class: "reservation-result__description" }, Qf = {
  __name: "ResultPage",
  props: {
    sid: {
      type: String,
  ...
  setup(e) {
    const t = e, { t: n } = Ce(), i = ft("settings"), r = ae(null), s = ae([]), l = ae(!0), { setError: u } = ft("globalError"), f = async () => {
      ...
      var h;
      return (h = r.value) != null && h.reservation ? Qc(r.value.reservation.status) : "";
    }), b = () => {
      s.value.forEach((h) => {
        console.log(h), window.open(h, "_blank");
      });
    };
    return qe(() => t.sid, f), Tt(f), (h, p) => (C(), ie(Sn, null, {
      default: B(() => [
        l.value ? (C(), ie(Tn, { key: 0 })) : (C(), D(ue, { key: 1 }, [
          w("section", Kf, [
            w("div", Jf, M(z(n)("reservation.title")), 1),
            w("div", Zf, M(z(n)(`reservation.description.${d.value}`)), 1)
          ]),
          N(Fi, {
            mode: "info",
          ...
          N(Ge, { class: "information-block--attention" }, {
            default: B(() => [
              N(kt, null, {
                default: B(() => [
                  Q(M(z(n)("reservation.whatIsNext")), 1)
                ]),
                _: 1
              }),
              N(Pe),
              N(Ie, null, {
                default: B(() => [
                  Q(M(z(n)(`reservation.nextStep.${d.value}`, { untilTime: "" })), 1)
                ]),
                _: 1
              }),
              r.value.payment.captureToken ? (C(), ie(Gf, {
                key: 0,
          ...
          r.value.reservation.specialRequest ? (C(), ie(Ge, { key: 0 }, {
            default: B(() => [
              N(kt, null, {
                default: B(() => [
                  Q(M(z(n)("reservation.specialRequest")), 1)
                ]),
                _: 1
              }),
              N(Pe),
              N(Ie, null, {
                default: B(() => [
                  Q(M(r.value.reservation.specialRequest), 1)
                ]),
                _: 1
              })
            ]),
...
}, em = { class: "reservation-result" }, tm = { class: "reservation-result__title" }, nm = { class: "reservation-result__description" }, im = { class: "accommodation-list__payment-rules" }, om = { style: { color: "orangered" } }, rm = { style: { color: "orangered" } }, am = { style: { display: "flex", "flex-direction": "row", "justify-content": "end", "column-gap": "0.5rem", padding: "1rem", "align-items": "center" } }, sm = ["value"], lm = { class: "agreement-rules-list__rules" }, cm = {
  ...
  setup(e) {
    ...
    }, { formatDescription: f } = Mi(), d = ae(""), b = ae(!1), h = async () => {
    ...
    return qe(() => t.sid, u), Tt(u), (p, x) => (C(), ie(Sn, null, {
      default: B(() => [
        s.value ? (C(), ie(Tn, { key: 0 })) : (C(), D(ue, { key: 1 }, [
          w("section", em, [
            w("div", tm, M(z(n)("cancellationProcess.title")), 1),
            w("div", nm, M(z(n)("cancellationProcess.description")), 1)
          ]),
          N(Fi, {
            mode: "cancellation",
            reservation: r.value.reservation,
            ...
            default: B(() => [
              N(Ie, null, {
                default: B(() => [
                  w("dl", im, [
                    w("dt", om, M(z(n)("chosenAccommodation.penalty")) + ":", 1),
                    w("dd", rm, M(r.value.reservation.penalties.total.amount) + " " + M(r.value.reservation.penalties.total.currency), 1)
                  ])
                ]),
                _: 1
              }),
              ...
              w("div", am, [
                ...
                N(Dr, {
                  ...
                  default: B(() => [
                    Q(M(z(n)("cancellationProcess.action")), 1)
                  ]),
                  _: 1
                }, 8, ["disabled"])
              ])
          ...
          N(Ge, { class: "information-block--attention" }, {
            default: B(() => [
              N(kt, null, {
                default: B(() => [
                  Q(M(z(n)("cancellationProcess.rules")), 1)
                ]),
                _: 1
              }),
              N(Pe),
...
}, dm = { id: "bflex-booking-widget" }, um = { class: "booking-widget" }, Fr = {
  ...
  setup(e) {
    ...
    const { setError: b } = ft("globalError"), h = (k) => {
      const { start: S, end: P, promoCode: g } = k.detail;
      d.value = { start: S, end: P, promoCode: g }, k.stopPropagation();
    };
    Tt(async () => {
      window.dispatchEvent(new CustomEvent("bflex:booking-widget:ready")), window.addEventListener("bflex:search-bar:search", h), l.value = !0;
      try {
        const { inProgress: k, settings: S } = await ua();
        n.value = S;
        const { widget: P } = S;
        P && P.locale && P.l10n && Object.keys(P.l10n).length && (Bn.global.locale.value = P.locale, Bn.global.setLocaleMessage(P.locale, P.l10n));
        const g = new URLSearchParams(window.location.search);
        g.has("cancelReservation") ? (x.value = g.get("cancelReservation"), console.log("Cancel reservation", x.value), s(ti)) : k ? s(cn) : s();
      } catch (k) {
        b(k);
      } finally {
        setTimeout(() => {
      ...
      window.removeEventListener("bflex:search-bar:search", h);
    });
    const p = ({ action: k, result: S }) => {
      k === yr ? s() : (k === Rn && (u.value = S.reservations[0]), s(k));
    }, x = ae(null);
    return (k, S) => (C(), D("main", dm, [
      w("div", um, [
        w("section", {
          ref_key: "container",
          ref: f,
          ...
          l.value ? (C(), ie(Sn, { key: 0 }, {
            default: B(() => [
              (C(), D(ue, null, Oe(3, (P) => N(Tn, { key: P })), 64))
            ]),
            _: 1
          })) : fe("", !0),
          x.value ? (C(), ie(cm, {
          ...
          }, null, 8, ["sid"])) : r.value === z(cn) ? (C(), ie(Iu, {
            key: 2,
            dateRange: d.value,
            promoCode: e.promoCode,
            onReleased: p
          }, null, 8, ["dateRange", "promoCode"])) : r.value === z(Rn) ? (C(), ie(Lf, {
            key: 3,
            onReleased: p
          })) : r.value === z(wo) ? (C(), ie(Qf, {
            key: 4,
            sid: u.value,
            onReleased: p
          }, null, 8, ["sid"])) : fe("", !0)
...
}, fm = { style: { display: "flex", "flex-direction": "column", "min-height": "300px", "justify-content": "center", "align-items": "center" } }, qr = {
  ...
  setup(e) {
    ...
    return qe(
      ...
      i && !i.__i18n_installed && (i.use(Bn), i.__i18n_installed = !0);
    }), xn(() => {
...
}, hm = /* @__PURE__ */ kn(pm, [["styles", [mm]]]), gm = {
  __name: "App",
  props: {
    start: {
      type: String,
...
function ym(e) {
  da(gm, { initOptions: e }).use(Bn).mount("#bflex-booking-widget");
}
export {
  Fr as BookingWidget,
  ym as mountWidget
